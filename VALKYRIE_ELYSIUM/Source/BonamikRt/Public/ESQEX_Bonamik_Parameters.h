...
enum ESQEX_Bonamik_Parameters {
    ...
    ESQEX_Bonamik_Parameters_LinkStr,
    ESQEX_Bonamik_Parameters_ConeLimit,
    ESQEX_Bonamik_Parameters_ConeOffset,
    ESQEX_Bonamik_Parameters_ConeLimitOffset,
    ESQEX_Bonamik_Parameters_ShapeSize,
};
